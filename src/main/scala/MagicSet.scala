...
trait MagicSet {
  ...
  def cost: Int = {
    ...
    var cost = 0
    cost += pt_bf.values.foldLeft(0)((a, b) => a+b.size)
    cost += pt_bb.values.foldLeft(0)((a, b) => a + b.size)
    cost += pt_fb.values.foldLeft(0)((a, b) => a + b.size)
    cost += pt_bbf.values.foldLeft(0)((a, b) => a + b.size)
    cost += pt_bbb.values.foldLeft(0)((a, b) => a + b.size)
    cost += pt_fbb.values.foldLeft(0)((a, b) => a + b.size)
    cost += pt_fbf.values.foldLeft(0)((a, b) => a + b.size)

    cost += magic_bf.size
    cost += magic_bbf.size

    cost += magic_bb.values.foldLeft(0)((a, b) => a + b.size)
    cost += magic_bbb.values.foldLeft(0)((a, b) => a + b.size)

    cost += magic_fbb.values.foldLeft(0)((a, b) => a + b.size)
    cost += magic_fbf.size
